...
class Embedding(object):
    ...
    def __init__(self, lexicon, vectors=None, embeddingSize=None, paddingIdx=None):
        ...
        self.__vectors = np.asarray(vectors, dtype=object) 
        #dtype=object gets rid of the ragged array deprication warning but might cause error later on: TypeError: can't convert np.ndarray of type numpy.object_.
        #print("Vectors being print from embedding.py\n", self.__vectors)
        print(self.__vectors.shape)
        print(self.__vectors.ndim)
        self.__embeddingSize = len(self.__vectors[0])

        #self.__embeddingSize = self.__vectors.shape[0]
        print(self.__embeddingSize)
        #self.__embeddingSize = self.__vectors.shape[1]
        #print(self.__embeddingSize)
        #error generated from running this line of code
        #vectors generated by last step seem to have one dimension only
