...
if __name__ == '__main__':
    ...
    logger.info(
        "Training:\t%d duplicate bugs\t%d of bug reports" % \
            (len(trainingSplitDuplicate), len(trainingSplitReports)))
    logger.info(
        "Validation:\t%d duplicate bugs\t%d of bug reports" % \
            (len(validationDuplicate), len(validationReports)))
    logger.info("Test:\t%d duplicate bugs\t%d of bug reports" % \
        (len(testDuplicateReports), len(testReports)))
